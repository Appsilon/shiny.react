...
/* harmony import */ var _ShinyProxy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ShinyProxy */ "./src/react/ShinyProxy.js");
/* harmony import */ var _mapReactData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mapReactData */ "./src/react/mapReactData.js");
...
function shinySetInputValue() {
  return function (inputId, value) {
    return _ShinyProxy__WEBPACK_IMPORTED_MODULE_4__.default.setInputValue(inputId, value);
  };
}
...
function selectSetInputValueFunction(props) {
  var inputId = props.inputId,
      ...
      debounce = props.debounce; // eslint-disable-line

  if (throttle && debounce) {
    throw new Error("Attempted to use throttle and debounce at the same time for React input ".concat(inputId));
  }
...
_ShinyProxy__WEBPACK_IMPORTED_MODULE_4__.default.addCustomMessageHandler('updateReactInput', function (_ref) {
  var inputId = _ref.inputId,
      data = _ref.data;

  if (inputId in updateHandlers) {
    updateHandlers[inputId]((0,_mapReactData__WEBPACK_IMPORTED_MODULE_5__.default)(data));
...
function InputAdapter(Component, valueProps) {
  function Adapter(_ref2) {
    ...
    var updateFunction = selectSetInputValueFunction(_objectSpread({
      inputId: inputId
    }, otherProps));

    var _useValue = useValue(inputId, defaultValue, updateFunction),
  ...
  Adapter.propTypes = {
    ...
    value: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().any.isRequired) // eslint-disable-line react/forbid-prop-types
...
function ButtonAdapter(Component) {
  function Adapter(_ref3) {
    ...
    var _useValue3 = useValue(inputId, null, updateFunction),
...
dataMappers.expr = function (_ref4) {
  var value = _ref4.value;
  return eval("(".concat(value, ")"));
}; // eslint-disable-line no-eval


dataMappers.array = function (_ref5) {
  var value = _ref5.value;
  return value.map(mapReactData);
};

dataMappers.object = function (_ref6) {
  var value = _ref6.value;
  return mapValues(value, mapReactData);
}; // eslint-disable-next-line react/prop-types


dataMappers.element = function (_ref7) {
...
window.jsmodule = _objectSpread(_objectSpread({}, window.jsmodule), {}, {
  ...
  '@/shiny': __webpack_require__(/*! @/shiny */ "@/shiny"),
